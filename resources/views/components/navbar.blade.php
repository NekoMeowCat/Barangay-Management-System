...
<header class="flex flex-wrap sm:justify-start sm:flex-nowrap z-50 w-full bg-blue-600 text-sm py-3 sm:py-0">
    <nav class="relative max-w-[85rem] w-full mx-auto px-4 sm:flex sm:items-center sm:justify-between sm:px-6 lg:px-8" aria-label="Global">
        <div class="flex items-center justify-between">
            <a class="flex-none text-xl font-extrabold font-poppins text-white" href="#" aria-label="Brand">San Mateo MIS</a>
        <div class="sm:hidden">
        ...
        <div class="flex flex-col gap-y-4 gap-x-0 mt-5 sm:flex-row sm:items-center sm:justify-end sm:gap-y-0 sm:gap-x-7 sm:mt-0 sm:ps-7">
            <a class="font-medium font-poppins text-white sm:py-6" href="#" aria-current="page">Home</a>
            <a class="font-medium font-poppins text-white/[.8] hover:text-white sm:py-6" href="#">About</a>
            <a class="font-medium font-poppins text-white/[.8] hover:text-white sm:py-6" href="#">Announcements</a>
            <a class="font-medium font-poppins text-white/[.8] hover:text-white sm:py-6" href="#">Map</a>

            <div class="hs-dropdown [--strategy:static] sm:[--strategy:fixed] [--adaptive:none] sm:[--trigger:hover] sm:py-4">
            <button type="button" class="flex items-center w-full text-white/[.8] hover:text-white font-medium font-poppins">
                Services
